...
from planet.views import blog_detail, blogs_list, feed_detail, feeds_list, foaf, tag_feeds_list
from planet.views import author_detail, authors_list, tag_authors_list, tag_detail, tags_cloud
from planet.views import foaf, opml, post_detail, posts_list, search, index
